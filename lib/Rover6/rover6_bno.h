...
void bno_print_system_status()
{
    ...
    println_info("BNO055 system status - %d, %s", bno_system_status, bno_status_string);
}
...
void bno_print_self_test()
{
    ...
    println_info("BNO055 accel self test - %s", bno_status_string);
    ...
    println_info("BNO055 mag self test - %s", bno_status_string);
    ...
    println_info("BNO055 gyro self test - %s", bno_status_string);
    ...
    println_info("BNO055 mcu self test - %s", bno_status_string);
}
...
void bno_print_system_error()
{
    ...
    println_info("BNO055 system error - %d, %s", bno_system_error, bno_status_string);
}
